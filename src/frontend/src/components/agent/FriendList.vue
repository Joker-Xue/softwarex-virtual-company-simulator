...
.friend-name { font-weight: 600; font-size: 16px; color: var(--text-primary); }
.friend-level { font-size: 13px; color: var(--accent-violet); font-family: var(--font-mono); }
...
.compat-tag { font-size: 13px; cursor: default; }

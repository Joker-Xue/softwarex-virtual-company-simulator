...
.event-count { margin-left: auto; font-family: var(--font-mono); font-size: 13px; color: var(--text-muted); }
...
.event-type { font-family: var(--font-mono); font-size: 12px; padding: 1px 6px; border: 1px solid; border-radius: 3px; flex-shrink: 0; }
.event-name { font-family: var(--font-body); font-size: 15px; font-weight: 600; color: var(--text-primary); flex: 1; }

.status-badge { font-family: var(--font-mono); font-size: 12px; padding: 2px 7px; border-radius: 3px; font-weight: 700; flex-shrink: 0; }
...
.info-item { font-family: var(--font-mono); font-size: 13px; color: var(--text-secondary); display: flex; align-items: center; gap: 3px; }
...
.decision-tag { font-family: var(--font-mono); font-size: 12px; padding: 2px 8px; border-radius: 3px; font-weight: 700; flex-shrink: 0; }
